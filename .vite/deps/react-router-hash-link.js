import { Link, NavLink } from "./chunk-MGXW7FYP.js";
import { require_prop_types } from "./chunk-YU7MVGIP.js";
...
function genericHashLink(As) {
  return import_react.default.forwardRef(function (props, ref) {
    ...
    function handleClick(e) {
      ...
      if (
        hashFragment !== "" && // ignore non-vanilla click events, same as react-router
    ...
    return import_react.default.createElement(
      As,
      __assign({}, passDownProps, filteredProps, { onClick: handleClick, ref }),
      props.children
    );
  });
}
