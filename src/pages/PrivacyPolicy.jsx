...
import '@assets/css/page/privacyPolicy/privacyPolicy.scss';
import HelmetMeta from '@components/Helmet/HelmetMeta';
import { useTranslation } from 'react-i18next';

export default function PrivacyPolicy() {
  const { t } = useTranslation(); // Importation de la traduction
  const title = t('helmet_privacy_t1', { defaultValue: 'Mentions Légales' });

  // Site web
  const urlWeb = 'https://visualandko.com/';

  // Entreprise
  const person1 = 'JULIEN ZUILI';
  const etpName = 'VISUAL & KO';
  const etpPhone = '07 67 74 43 88';
  const etpType = 'EURL';
  const etpCapital = '1000€';
  const tvaNumber = 'FR12909395758';
  const etpAddress = '3 rue keller 75012 PARIS';
  const etpContatMail = 'contact@visualandko.com';

  // Hebergeur
  const hebergeurName = 'titan DATACENTER';
  const hebergeurAddress = '1210 Chem. de la Plaine 06250 Mougins 09 88 99 88 88';

  return (
    <>
      <HelmetMeta title={title} description="" />
      ...
      <section className="privacyPolicy">
        ...
        <p>
          ...
          {' '}
          Tout professionnel ou personne physique
        ...
        <p>
          ...
          {' '}
          Ensemble des éléments constituants
        ...
        <p>
          ...
          {' '}
          Ci après dénommé « Information
          (s) » qui correspondent à l’ensemble des données personnelles
          susceptibles d’être détenues par
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          pour la gestion de votre compte, de
          la gestion de la relation client et à des fins d’analyses et de
          statistiques.
        </p>
        <p>
          <strong>Utilisateur :</strong>
          {' '}
          Internaute se connectant, utilisant le
          site susnommé.
        </p>
        <p>
        ...
        <p>
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          sont donc invités à les consulter de
          manière régulière.
        </p>
        ...
        <p>
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          responsable. De la même façon, les
        ...
        <p>
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          est hébergé chez un prestataire sur
        ...
        <p>
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          et l’hébergeur ne pourront être
        ...
        <p>
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          est propriétaire des droits de
        ...
        <p>
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          se réserve le droit de supprimer,
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          se réserve également la possibilité
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          est représenté par JULIEN ZUILI, son
          représentant légal
        </p>
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          s’engage à respecter le cadre des
        ...
        <p className="sub1">
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          est susceptible de traiter tout ou
          partie des données :
        </p>
        <p className="sub1">
          <ul>
        ...
        <p className="sub1">
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          ne commercialise pas vos données
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          a connaissance du décès d’un
          Utilisateur et à défaut d’instructions de sa part,
          {' '}
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          s’engage à détruire ses données,
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          peuvent déposer une réclamation
        ...
        <p className="sub1">
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          s’interdit de traiter, héberger ou
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          sont principalement les agents de
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          utilise des réseaux protégés par des
        ...
        <p>
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          n’a pas la possibilité de vérifier
        ...
        <p className="sub1">
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          est susceptible de traiter les
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          informe l’Utilisateur que, dans ce
          cas, il se peut que les fonctionnalités de son logiciel de navigation
        ...
        <p className="sub1">
          ...
          {' '}
          <Link to={urlWeb}>{urlWeb}</Link>
          , résultant (i) du refus de Cookies
        ...
        <p className="sub1">
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          pourra en outre faire appel aux
        ...
        <p className="sub1">
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          peut employer occasionnellement des
        ...
        <p>
          ...
          <Link to={urlWeb}>{urlWeb}</Link>
          {' '}
          est soumis au droit français. En
